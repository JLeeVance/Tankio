...
function BioloadInfo({ onDialogClose }){
    ...
    return(
        <Dialog
            ...
            >
            <DialogTitle variant='h1' sx={{ color:'rgb(20, 99, 142)', fontSize:'5.5vh'}}>
                Understanding Bioload
            </DialogTitle>
            <DialogContent>
                <DialogContentText>
                    <Box container>
                        <Typography variant='h6' sx={{marginTop:'3%', color:'rgb(20, 99, 142)'}}>
                            WHAT
                            <Divider sx={{ marginBottom:'1%', backgroundColor:'rgb(20, 99, 142)', height:'.5px', marginRight:49, marginLeft:49, marginBottom:3.5}}/>
                        ...
                        <Typography variant='h6' sx={{marginTop:'3%', marginBottom:'4.5%', color:'rgb(20, 99, 142)'}}>
                            HOW
                            <Divider sx={{marginBottom:'1%', backgroundColor:'rgb(20, 99, 142)', height:'.5px', marginRight:49, marginLeft:49, marginBottom:3.5}} />
                            <Typography variant='body1'>
